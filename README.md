...
- **פתרון קישורי s.click** – עוקב אחרי רידיירקטים כדי לחלץ את כתובת המוצר האמיתית לפני בניית הלינק האישי, כך שלא תיתקע בדף כללי.
...
- אם אתה מקבל לינקים כלליים ולא מוצר ספציפי: ודא ש-`RESOLVE_REDIRECTS` מופעל (ברירת מחדל) ושהזמן ב-`RESOLVE_REDIRECT_TIMEOUT` מספיק כדי לגלות את כתובת המוצר לפני בניית הלינק האישי.
